...
export const awr033: RequirementDef[] = [
  {"id":"AWR033:PERMIT","framework":"CAA AWR 033","clause":"AWR 033 Rev 8","title":"Drone permit application per operation (new / extension / renewal)","summary":"Operations require a CAA permit; the application captures operation type, company category, purpose, full aircraft particulars (type, model, serial, weights, frequency, ceiling, range, speed, endurance, navigation systems, camera, control method, VLOS/BVLOS), investor/owner/operator particulars, declarations, per-location coordinates (governorate/wilayat/village, lat/long), required operational altitude (max 400 ft / 122 m AGL-MSL), and proposed flying dates and times; permit number issued on approval.","recordTypes":["mission_record","registration"],"version":"Rev 8","kind":"guidance","jurisdiction":"Oman"},
  {"id":"AWR033:MEDIA","framework":"CAA AWR 033","clause":"AWR 033 Rev 8 (Attention note)","title":"Media announcements must credit CAA authorization","summary":"Any announcement of drone operations in media (TV, radio, press, social media) must state that the operation is authorized by the Civil Aviation Authority.","recordTypes":["mission_record"],"version":"Rev 8","kind":"guidance","jurisdiction":"Oman"},
];
